...
{
    public class MonthlyOperationRepository : IMonthlyOperationRepository
    {
        ILog log = LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        MyDbContext db;
        public MonthlyOperationRepository()
        {
            this.db = new MyDbContext();
        }

        public IEnumerable<vMonthlyOperation> Search(string searchBy, string keyWord, string startDate, string endDate, string orderBy, string order, out int totalRecords)
        {
            IEnumerable<vMonthlyOperation> lstRecords = null;
            try
            {
                lstRecords = (from l in db.vMonthlyOperation select l).AsEnumerable();
