...
namespace MyClinic.Controllers
{
    ...
    public class MonthlyOperationController : Controller
    {
        ILog log = LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        MyClinic.Infrastructure.Log logTran = new MyClinic.Infrastructure.Log();
        ILogRepository logRepository = new LogRepository();
        IMonthlyOperationRepository objMonthlyOperationRepository = new MonthlyOperationRepository();
        ...
        {
            MonthlyOperationModels objViewsModels = null;
            try
            {
                string searchBy = "";
                string keyword = "";
                ...
                var totalRecords = 0;
                var lstRecords = objMonthlyOperationRepository.Search(searchBy, keyword, startDate, endDate, orderBy, order, out totalRecords);

                objViewsModels = new MonthlyOperationModels()
                {
